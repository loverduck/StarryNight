		...
		try {
			...
			if(FB_Resourse != null) {
				...
				if (SA.Common.Config.FB_SDK_MajorVersionCode == 6) {
					...
					System.Reflection.PropertyInfo Instance  = fb_settings.GetProperty("GetInstance", System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.NonPublic);

...
public class BlinkStar : MonoBehaviour {
    ...
    public void OnClick()
    {
        ...
        {
            currentItemNum = DataController.GetInstance().GetGold();
        }
        ...
        if (checkItemCount == currentItemNum)
        {
            ...
            {
                DataController.GetInstance().AddGold(currentQuest.rewardCount);
            }
            else if (currentQuest.reward > 50000)
            {
                if (currentQuest.termsItem == 9999)
                {
                    DataController.GetInstance().SubGold(currentQuest.termsCount);
                }
            ...
            else
            {
                ...
                DataController.GetInstance().AddItem(currentQuest.reward, currentQuest.rewardCount);
            }
